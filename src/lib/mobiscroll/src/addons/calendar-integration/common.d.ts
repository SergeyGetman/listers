...
export interface MbscCalendarSync<T extends MbscCalendarSyncConfig> {
  ...
  getEvents(
    ...
    callback?: (events: MbscCalendarEvent[]) => void,
  ): Promise<any>;
  addEvent(
    calendarId: string,
    event: MbscCalendarEvent,
    callback?: (addedEvent: MbscCalendarEvent) => void,
  ): Promise<any>;
  updateEvent(
    calendarId: string,
    event: MbscCalendarEvent,
    callback?: (updatedEvent: MbscCalendarEvent) => void,
  ): Promise<any>;
  deleteEvent(
    calendarId: string,
    event: MbscCalendarEvent,
    callback?: (deletedEvent: MbscCalendarEvent) => void,
  ): Promise<any>;
}
