 ...
 */
export declare function checkDateRangeOverlap(
  start1: Date,
  end1: Date,
  start2: Date,
  end2: Date,
...
/** @hidden */
export declare function getEndDate(
  s: IDatetimeProps,
...
/** @hidden */
export declare function adjustedDate(
  y: number,
  m: number,
  d: number,
  h?: number,
...
export declare function createDate(
  s: any,
  year: number,
  month: number,
  date: number,
...
/** @hidden */
export declare function returnDate(
  d: Date,
  s: IDatetimeProps,
