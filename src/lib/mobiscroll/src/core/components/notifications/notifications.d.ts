 ...
 */
export declare function getToastOptions(
 ...
 * @param resolve Promise resolve function to be called on close.
 */
export declare function getSnackbarOptions(
  options: MbscSnackbarOptions,
  destroy: () => void,
  resolve: () => void,
): MbscPopupOptions;
/**
 ...
 * @param resolve Promise resolve function to be called on close.
 */
export declare function getAlertOptions(
  options: MbscAlertOptions,
  destroy: () => void,
  resolve: () => void,
): MbscPopupOptions;
/**
