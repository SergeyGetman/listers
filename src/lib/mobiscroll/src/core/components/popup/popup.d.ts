...
/** @hidden */
export declare function processButtons(
  inst: any,
  buttons?: Array<IPopupButton | MbscPopupButton | string>,
): IPopupButton[] | undefined;
/**
 * @hidden
 */
export declare class PopupBase extends BaseComponent<MbscPopupOptions, MbscPopupState> {
  ...
  _onButtonClick: ({ domEvent, button }: { domEvent: any; button: MbscPopupButton }) => void;
