...
import CreateEventModalContainer from './components/CreateEventModalContainer';
import modalObserver, { ModalProps } from '../../../shared/utils/observers/modalObserver';

const CreateEventModal = ({ isOpen, props }: ModalProps) => {
      ...
      if (isShowUnsavedDataModal && !isSubmitted) {
        modalObserver.addModal(ModalNamesEnum.baseConfirmModal, {
          props: {
            ...
            handleConfirm: () => modalObserver.removeModal(ModalNamesEnum.createEventModal),
          },
        });
      } else {
        modalObserver.removeModal(ModalNamesEnum.createEventModal);
      }
    },
