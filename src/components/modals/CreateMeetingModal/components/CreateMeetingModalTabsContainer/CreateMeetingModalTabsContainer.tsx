...
type CreateMeetingModalTabsContainerProps = {
  attachments: MediaType[];
  handleAddAttachment: (files: MediaType[]) => void;
  entityType: DocumentsEntityTypeEnum;
};
const CreateMeetingModalTabsContainer: FC<CreateMeetingModalTabsContainerProps> = ({
  attachments,
  handleAddAttachment,
  entityType,
}) => {
  ...
  const navigationMenu = [
    {
      item: plannerItemNavigationConfig[PlannerItemNavigationEnum.agenda],
    },
    {
  ...
  return (
    <Box>
      <TabContext value={value}>
        ...
        <TabPanel sx={{ height: '100%', p: '0' }} value={PlannerItemNavigationEnum.agenda}>
