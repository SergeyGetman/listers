...
import { setPlannerFilters } from '../../../../../store/planner/plannerSlice';
...
type PlannerFiltersModalContainerProps = {
...
const PlannerFiltersModalContainer: FC<PlannerFiltersModalContainerProps> = ({
  onClose,
  setIsShowUnsavedDataModal,
}) => {
  const dispatch = useAppDispatch();
  const { filters } = useAppSelector(({ planner }) => planner);
  ...
  }, [filters.entities, filters.event_statuses, filters.payment_statuses, filters.task_statuses]);
  ...
  const onSubmit = (val: any) => {
    ...
    dispatch(setPlannerFilters({ ...filters, ...submitData }));
    onClose(true);
