...
import { setRoadmapFilters } from '../../../../../store/roadmap/roadmapSlice';
...
type RoadmapFiltersModalContainerProps = {
  onClose: (isSubmitted?: boolean) => void;
  setIsShowUnsavedDataModal: (val: boolean) => void;
};
const RoadmapFiltersModalContainer: FC<RoadmapFiltersModalContainerProps> = ({
  onClose,
  ...
  const onSubmit = (val: any) => {
    ...
    dispatch(setRoadmapFilters({ ...filters, ...submitData }));
    onClose(true);
            ...
            <Controller
              ...
              render={({ field }) => (
                <MuiSelect
                  ...
                  placeholder={t('general.placeholders.select_assignee_or_creator')}
                />
              )}
            />
          </Box>
            ...
            <Controller
              ...
              render={({ field }) => (
                <MuiSelect
                  ...
                  placeholder={t('general.placeholders.select_task_creator')}
                />
              )}
            />
          </Box>
