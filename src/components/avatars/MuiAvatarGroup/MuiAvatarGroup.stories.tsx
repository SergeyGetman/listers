...
} as ComponentMeta<typeof MuiAvatarGroup>;

const Template: ComponentStory<typeof MuiAvatarGroup> = (args) => <MuiAvatarGroup {...args} />;
...
const formatUsers = [
  ...
  },
  {
    ...
    status: PlannerItemStatusesEnum.pending,
  },
  {
    avatar: {
      additional_info: {
...
export const MuiAvatarGroupStory = Template.bind({});
MuiAvatarGroupStory.args = {
  users: formatUsers,
  owner,
  maxItemView: 2,
};
