...
const PlansStep = ({ recommendedPlan }: { recommendedPlan: PlansPricingItemEnum }) => {
  ...
  const [selectedPlan, setSelectedPlan] = useState(PlansPricingItemEnum.starter);
